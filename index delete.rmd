---
title: Econometría para los mercados financieros EMF. #`r fontawesome::fa("chart-line")` 
...
# [`r fa("arrow-circle-up", fill = "black")`](https://mlozanoqf.github.io/EMF/) [<span style="color: black">Back to top.</span>](https://mlozanoqf.github.io/EMF/) {-}
...
```{r evaluation, child = 'Evaluation EMF.Rmd'}
```
